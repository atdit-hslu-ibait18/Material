...
public class Library {
	...
	{
		//book is null?
		//isbn already existing?
		books.put(book.isbn, book);
	}
	
	public Book getBook(String isbn)
	{
		//what happens if book not in lib?
	...
	public void clearReservation(String isbn) throws Exception
	{
		if (books.get(isbn) != null)
		{
			//reservations.remnove(isbn);
			//here should be a delete
	...
	public Boolean getReservationStatus(String isbn) throws Exception
	{
		if (books.get(isbn) != null)
		{
